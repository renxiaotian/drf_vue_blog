...
<template>
    <div id="header">
        <div class="grid">
            <div></div>
            <h1><router-link to="/">My Drf-Vue Blog</router-link></h1>

            <!--引入搜索框组件-->
            <ArtSearchButton></ArtSearchButton>
...
import ArtSearchButton from '@/components/ArtSearchButton.vue'
import authorization from '@/utils/authorization';
export default {
    name: 'BlogHeader',
    components: { ArtSearchButton },
    // props: ['welcomeName'],
    // computed: {
    //     name() {
